...
function App() {
  ...
  useEffect(() => {
    passwordGenerator()
  }, [length, numberAllowed, setNumberAllowed, charAllowed, passwordGenerator])
    ...
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 bg-gray-800 text-orange-500">
      ...
      <div className="flex text-sm gap-x-2">
        <div className="flex items-center gap-x-1">
          <input type="range" min={6} max={100} className="cursor-pointer" value={length} onChange={(e) => {
        ...
        <div className="flex items-center gap-x-1">
          <input type="checkbox" id="numberInput" defaultChecked = {charAllowed} onChange={() => {
